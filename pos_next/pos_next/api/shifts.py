...
def create_opening_shift(pos_profile, company, balance_details):
	...
	# Reset invoice numbering for new shift (starts from 0, first invoice will be 1)
	try:
		new_pos_opening.custom_last_invoice_number = 0
	except Exception:
		# Custom field might not exist, continue without it
		pass
